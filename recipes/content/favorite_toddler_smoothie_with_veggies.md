---
id: favorite_toddler_smoothie_with_veggies
name: Favorite Toddler Smoothie (with Veggies!)
categories:
- ''
cuisine: unknown
meal_type: breakfast
...
avoid_contains: []
source_url: null
source_file: Favorite Toddler Smoothie (with Veggies!).html
---
...
- Optional add-ins
- AD
- 1cupmilk (I prefer nondairy)
- 1smallbanana (fresh or frozen)
...
6. AD
7. Add chosen ingredients to a blender.
8. Blend until very smooth, stopping to scrape down the sides of the bowl and adding more liquid if needed.
9. Serve immediately.
