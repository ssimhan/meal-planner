...
def generate_meal_plan(input_file, data, recipes_list=None, history_dict=None, exclude_defaults=None):
    ...
    try:
        ...
        print(f"[DEBUG] Processing week: {week_of}")
        ...
        if days_needing_dinner:
            ...
            print(f"[DEBUG] Selecting dinners for {len(days_needing_dinner)} days...")
            ...
            print(f"[DEBUG] Selected {len(selected_dinners)} dinners.")
        ...
        if any_lunch_needed:
            ...
            print(f"[DEBUG] Selecting weekly lunches...")
            ...
            print(f"[DEBUG] Selected {len(selected_lunches)} lunches.")
        ...
        print(f"[DEBUG] generate_meal_plan completed successfully.")
        return data, history
    except Exception as e:
        import traceback
        print(f"[ERROR] generate_meal_plan failed: {e}")
        traceback.print_exc()
        raise e
